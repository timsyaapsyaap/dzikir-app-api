...
func versesByChapter(chapter int) string {
	return fmt.Sprintf("/api/v4/verses/by_chapter/%v?language=id&fields=text_uthmani,text_indopak&translations=33&audio=7&word_fields=id", chapter)
}
